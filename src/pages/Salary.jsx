    ...
    <div>
      ...
      {showForm && (
        <form onSubmit={handleAdd} className="badge-card p-5 mb-6 max-w-xl">
          ...
          <label className="flex items-center gap-2 text-sm text-gy-ink/70 mb-4">
            <input
              type="checkbox"
              checked={form.paid}
      ...
      <div className="badge-card p-4 mb-6 max-w-xs">
        <p className="text-xs font-mono uppercase text-gy-ink/50">Total payroll</p>
        <p className="text-2xl font-display font-semibold text-gy-ink">
      ...
      <div className="badge-card overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody>
            {loading && (
              <tr>
                <td colSpan={6} className="px-4 py-6 text-center text-gy-ink/40">
                  Loading…
                </td>
              </tr>
            )}
            ...
            {staff.map((s) => {
              ...
              return (
                <tr key={s.id} className="border-t border-gy-line">
                  ...
                  <td className="px-4 py-3 text-gy-ink/60">{s.role}</td>
